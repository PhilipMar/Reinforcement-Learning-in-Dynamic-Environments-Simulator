...
class AgentExceedsOptimalPathStaticTest {
    ...
    void testWithTolerance() {
        ...
        Criterion criterion = new AgentExceedsOptimalPathStatic(5);
        ...
        agent.setNumberOfActionsTaken(shortestPath + 5);
        Assertions.assertFalse(criterion.isMet(training));

        // Agent exceeds tolerance,
        agent.setNumberOfActionsTaken(shortestPath + 6);
        Assertions.assertTrue(criterion.isMet(training));
    }
    ...
    void testWithoutTolerance() {
        ...
        Criterion criterion = new AgentExceedsOptimalPathStatic(0);
